...
Gem::Specification.new do |s|
  ...
  s.add_dependency 'opentelemetry-instrumentation-http_client', '= 0.22.1'
  s.add_dependency 'opentelemetry-instrumentation-redis', '= 0.25.1'
  s.add_dependency 'opentelemetry-instrumentation-sinatra', '= 0.23.1'
  s.add_dependency 'opentelemetry-resource_detectors', '= 0.23.0'
